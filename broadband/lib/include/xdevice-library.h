...
BOOL getPartnerName(char *outValue);
BOOL getFriendlyName(char *outValue);
BOOL getProductName(char *outValue);
BOOL getServiceName(char *outValue);
BOOL getServiceDescription(char *outValue);
BOOL getGatewayName(char *outValue);
